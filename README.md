...
var generated = validator.generate(filename, source);
...
**`generate(filepath, descriptor)`**: Takes the filepath or similiar (to generate the
classname and the namespace) and the descriptor object generated by `parse`.
Returns a string with the generated PHP code.
